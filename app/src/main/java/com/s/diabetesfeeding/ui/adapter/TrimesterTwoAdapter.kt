...
class TrimesterTwoAdapter(val context: Context, val trimesterTopics : List<TrimesterDataTwo>) : RecyclerView.Adapter<TrimesterTwoAdapter.TrimesterViewHolder>(){
    ...
    fun update(dataOne: TrimesterDataTwo) {
        Coroutines.io {
            context.let {
