...
import com.s.diabetesfeeding.ui.TrimesterAdapter
...
class TrimesterFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        arguments?.getString(TrimesterFragment.ARG_PARAM1)?.let {
            tv_title?.text  = it
        }
    ...
    private fun showTrimesterTopics(trimesterTopics: List<TrimesterData>) {
        ...
        rv_trimester_topic.adapter = TrimesterAdapter(trimesterTopics)
    }
        ...
        fun newInstance(param1: String, param2: String) =
            TrimesterFragment().apply {
                arguments = Bundle().apply {
                    putString(TrimesterFragment.ARG_PARAM1, param1)
                    putString(TrimesterFragment.ARG_PARAM2, param2)
                }
            }
        private const val ARG_PARAM1 = "param1"
        private const val ARG_PARAM2 = "param2"
